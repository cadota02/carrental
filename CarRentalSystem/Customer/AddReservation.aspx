<%@ Page Title="Book Car" Language="C#" MasterPageFile="~/SiteCustomer.Master" AutoEventWireup="true" CodeBehind="AddReservation.aspx.cs" Inherits="CarRentalSystem.Customer.AddReservation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_body" runat="server">
        ...
        <div class="col-md-12">
          <div class="card card-info">
            <div class="card-header">
              <h3 class="card-title">Customer Reservation</h3>
   ...
   <div class="input-group input-group-sm" style="width: 300px;">
     ...
     <asp:HyperLink ID="HyperLink1"  CssClass="btn btn-info pt-1" runat="server" NavigateUrl="~/AddReservation"><i class="fas fa-sync-alt"></i></asp:HyperLink>
           </div>
   </div>
                                ...
                                <div class="col-md-4 mb-2 d-flex align-items-stretch" id='car_<%# Eval("car_id") %>'>
                                    <div class="card shadow-sm">
                                       ...
                                       <div class="accordion" id='accordion<%# Eval("car_id") %>'>
                                        ...
                                        <asp:Button ID="btnSelect" runat="server" CssClass="btn btn-outline-success btn-sm" Text="Select Car" CommandArgument='<%# Eval("car_id") %>' OnCommand="btnSelect_Command" />
          ...
          <asp:Button ID="btnNext" runat="server" Text="&raquo;" CssClass="scroll-btn scroll-right text-lg" OnClick="btnNext_Click" />
            ...
            <!-- Booking Form -->
                     ...
                     <div class="card-footer">
                           ...
                           <asp:HyperLink ID="linkprint" class="btn btn-default  float-right" runat="server"   Text="Print booking" Target="_blank" ></asp:HyperLink>
